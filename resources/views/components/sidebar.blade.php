    ...
    <aside id="separator-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium">
                @if (Auth::check() && Auth::user()->globals_role == 'user')
                    <li>
                        <a href="{{ route('user.home') }}"
                            class="{{ request()->routeIs('user.home') ? 'bg-gray-100 text-blue-600' : 'text-gray-900' }} flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                @endif
                @if (Auth::check() && Auth::user()->globals_role == 'admin')
                    <li>
                        <a href="{{ route('admin.home') }}"
                            class="{{ request()->routeIs('admin.home') ? 'bg-gray-100 text-blue-600' : 'text-gray-900' }} flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" />
                    ...
                    <li>
                        <a href="{{ route('admin.roles.index') }}"
                            class="{{ request()->routeIs('admin.roles.index') ? 'bg-gray-100 text-blue-600' : 'text-gray-900' }} flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.categories.index') }}"
                            class="{{ request()->routeIs('admin.categories.index') ? 'bg-gray-100 text-blue-600' : 'text-gray-900' }} flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
